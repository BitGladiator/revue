...
const Dashboard = () => {
  ...
  const { notifications, unreadCount, markRead, markAllRead } = useReviewSocket(
    user?.id
  );
  ...
  const totalReviewed = repos.reduce(
    (s, r) => s + parseInt(r.reviewed_prs || 0),
    0
  );
            ...
            >
              ...
              >
                <span
                  style={{
                    fontSize: "12px",
                    color: repo.private ? "#718096" : "#38A169",
                  }}
                >
